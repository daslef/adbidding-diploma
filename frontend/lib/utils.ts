...
export const formatDateTime = (date) => {
  ...
  try {
    return new Date(date).toLocaleString('en-US', {
      ...
      second: '2-digit',
      hour12: true,
      timeZone: 'UTC' // Consistent timezone for all users
    });
  } catch (error) {
...
export function calculateTimeLeft(endDate: string): { milliseconds: number; formatted: string } {
